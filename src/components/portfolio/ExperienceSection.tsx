  ...
  const experiences = [
    {
      ...
      technologies: ["React.js", "Node.js", "Express.js", "Zustand", "TypeScript", "React Query", "MongoDB", "JavaScript", "TailwindCSS"]
    }
  ];
            ...
            <div className="space-y-12">
              {experiences.map((experience, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <motion.div
                    className="absolute left-4 md:hidden w-4 h-4 bg-gradient-to-r from-primary to-accent rounded-full border-4 border-background transform md:-translate-x-1/2 z-10"
                    initial={{ scale: 0 }}
                  ...
                  {/* Content card */}
                  <motion.div
                    className={`flex-1 ml-12 md:ml-0 md:w-5/12 ${index % 2 === 0 ? 'md:text-left' : ''
                      }`}
